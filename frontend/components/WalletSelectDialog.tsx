    ...
    <div id="modal-overlay" className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 font-[family-name:var(--font-geist-mono)]" onClick={handleOutsideClick}>
      <div className="bg-black rounded-lg shadow-lg p-6 w-80">
        ...
        <div className="flex flex-col gap-4">
          <button
            className="flex items-center gap-3 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-all"
            onClick={() => {
          ...
          <button
            className="flex items-center gap-3 bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg transition-all"
            onClick={() => {
              connectToMetamask();
              setOpen(false);
              onClose("Metamask");
